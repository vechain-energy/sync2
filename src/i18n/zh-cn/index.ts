...
export default {
    ...
    address: {
        ...
        msg_vns_profile_upload_error: '头像上传失败。',
        msg_vns_profile_sign_error: 'you need the owner or manager wallet for {name}. 资料更新未签名。',
    ...
    domains: {
        ...
        msg_available: '域名可注册',
        msg_unavailable: '域名不可用',
        msg_committed: '承诺交易已提交',
        msg_submitted: '注册交易已提交',
        msg_registration_confirmed: '域名注册交易已提交',
        msg_primary_confirmed: '{name} 已成为您的主域名',
        msg_keep_open: '请保持此页面打开。注册需要本次生成的密钥。',
        msg_wait_seconds: '等待 {seconds} 秒',
        comment_commit: '提交 {name} 承诺',
        comment_register: '注册 {name}'
    },
    activities: {
        title: '操作记录',
