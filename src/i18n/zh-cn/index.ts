...
export default {
    ...
    sign: {
        ...
        label_max_fee: '最大手续费',
        label_fee_token: '手续费代币',
        label_fee_payer: '手续费支付方',
        label_fee_payer_account: '账户',
        label_fee_payer_dapp: 'DApp',
        label_fee_token_standard: '标准手续费',
        label_priority_regular: '普通',
        label_priority_medium: '中',
        label_priority_high: '高',
        action_sign: '签名',
        msg_generic_delegation: 'Generic Delegator',
        msg_account_fee_delegation: '手续费由所选账户支付',
        msg_generic_fee_balance_ok: '余额足够',
        msg_generic_fee_balance_low: '余额不足',
        msg_generic_fee_unavailable: 'Generic Delegator 手续费不可用',
        msg_local_fee_balance_ok: 'VTHO 足够',
        msg_local_fee_balance_low: 'VTHO 不足',
        msg_local_fee_unavailable: '本地手续费支付账户不可用',

        // error occurred
        label_insufficient_vtho: 'VTHO不足',
        msg_insufficient_vtho: 'VTHO余额不足以发送交易',
        msg_insufficient_local_vtho: '所选手续费支付账户需要更多 VTHO',
        label_insufficient_fee_token: '手续费代币不足',
        ...
        msg_generic_delegation_failed: '请求 Generic Delegator 签名失败',
        msg_local_delegation_failed: '所选手续费支付账户签名失败',
