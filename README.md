...
- `.vet` names can be checked and registered with VET through the Domains menu, with wallet/signing selection, a registration confirmation screen, and optional primary name setup.
